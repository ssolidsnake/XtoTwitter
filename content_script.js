const XtoT=(function(){
	function titleXToT(){
		console.log("Change title start");
	...
	function pathXToT(){
		console.log("START PATH"+typeof document.body);
